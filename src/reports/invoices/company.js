...
const mapStateToProps = ({ storageCompanies, storageHelpCompanyInvoices }) => {
...
export default connect(mapStateToProps, { storageCompaniesStart, storageHelpCompanyInvoicesStart })(CompanyReports);
