    ...
    <div>
      ...
      <div className="row center center-ver h-100vh">
        ...
        <div className="main">
          ...
          { accessRights.vykazy && <Route exact path="/invoices" component={Reroute} /> }
          { accessRights.vykazy && accessRights.viewErrors && <Route exact path="/invoices/errorMessages" component={ErrorMessages} /> }
          { accessRights.vykazy && <Route exact path="/invoices/monthly/companies" component={CompanyMonthlyReport} /> }
          { accessRights.vykazy && <Route exact path="/invoices/monthly/agents" component={AgentMonthlyReport} /> }
          { accessRights.vykazy && <Route exact path="/invoices/invoices" component={Invoices} /> }
