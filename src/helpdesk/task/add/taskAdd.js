        ...
        return ( <
...

          {
            ...
            /div> {
              ...
              isDisabled = {
                defaultFields.assignedTo.fixed || viewOnly
              }
              isMulti
              onChange = {
                ( users ) => setAssignedTo( users )
              }
              options = {
            ...
            div className = "col-4" > {
                ...
                isDisabled = {
                  defaultFields.status.fixed || viewOnly
                }
                styles = {
                  invisibleSelectStyleNoArrowColoredRequired
                }
                ...
                isDisabled = {
                  defaultFields.taskType.fixed || viewOnly
                }
                styles = {
                  invisibleSelectStyleNoArrowRequired
                }
                ...
                options = {
                  milestones.filter( ( milestone ) => milestone.id === null || ( project !== null && milestone.project === project.id ) )
                }
                styles = {
                  invisibleSelectStyleNoArrow
                }
              ...
              div className = "col-4" > {
                ...
                placeholder = "Select required"
                isDisabled = {
                  defaultFields.requester.fixed || viewOnly
                }
                onChange = {
                  ( requester ) => {
                ...
                placeholder = "Select required"
                isDisabled = {
                  defaultFields.company.fixed || viewOnly
                }
                onChange = {
                  ( company ) => {
                    setCompany( company );
                ...
                placeholder = "Select required"
                isDisabled = {
                  viewOnly || !company || company.monthly || defaultFields.pausal.fixed
                }
                styles = {
                  invisibleSelectStyleNoArrowRequired
                }
                onChange = {
                  ( pausal ) => setPausal( pausal )
                }
                options = {
                  booleanSelects
                }
            ...
            /div> {
              ...
              isDisabled = {
                viewOnly || defaultFields.overtime.fixed
              }
              styles = {
                invisibleSelectStyleNoArrowRequired
              }
      ...
      const renderSelectsLayout2 = () => {
        return ( <
...

          {
            ...
            options = {
              statuses.filter( ( status ) => status.action !== 'invoiced' ).sort( ( item1, item2 ) => {
...

          {
...

            {
              ...
              placeholder = "None"
              isDisabled = {
                defaultFields.tag.fixed || viewOnly
              }
              isMulti
              onChange = {
                ( t ) => setTags( t )
        ...
        const renderVykazyTable = ( subtasks, workTrips, materials, customItems ) => {
          return ( <
            ...
            showSubtasks = {
              project ? project.showSubtasks : false
            }
            ...
            updateSubtask = {
              ( id, newData ) => {
                ...
                newSubtasks[ newSubtasks.findIndex( ( taskWork ) => taskWork.id === id ) ] = {
                  ...newSubtasks.find( ( taskWork ) => taskWork.id === id ),
                  ...newData
                };
            ...
            updateTrip = {
              ( id, newData ) => {
                ...
                newTrips[ newTrips.findIndex( ( trip ) => trip.id === id ) ] = {
                  ...newTrips.find( ( trip ) => trip.id === id ),
                  ...newData
                };
            ...
            updateMaterial = {
              ( id, newData ) => {
                ...
                newMaterials[ newMaterials.findIndex( ( material ) => material.id === id ) ] = {
                  ...newMaterials.find( ( material ) => material.id === id ),
                  ...newData
                };
            ...
            updateCustomItem = {
              ( id, newData ) => {
                ...
                newCustomItems[ newCustomItems.findIndex( ( customItem ) => customItem.id === id ) ] = {
                  ...newCustomItems.find( ( customItem ) => customItem.id === id ),
                  ...newData
                };
        ...
        const renderButtons = () => {
          return ( <
            ...
            disabled = {
              title === "" || status === null || project === null || assignedTo === [] || company === null || saving || loading
            }
            onClick = {
              addTaskFunc
            } >
        ...
        return ( <
          ...
          div className = {
            classnames( {
              "task-edit-left p-l-20 p-r-20 p-b-15 p-t-15": layout === 2
            } )
          } >
