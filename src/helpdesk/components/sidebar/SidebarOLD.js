...
import ProjectEdit from '../projects/projectEditUNUSED';
...
class Sidebar extends Component {
	...
	/*
		...
		componentWillReceiveProps(props){
			...
			//prec - but pridaj moynost pridat cez {label "Add vec"}  atd, use [dashboard]
			...
			if(!sameStringForms(props.milestones,this.props.milestones)||!sameStringForms(this.props.currentUser,props.currentUser)){
				...
				//prec - but pridaj moynost pridat cez {label "Add vec"}  atd, use [allMilestones]
				this.setState({
